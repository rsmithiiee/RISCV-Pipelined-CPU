...
- **Icarus Verilog docs** — [iverilog.icarus.com](http://iverilog.icarus.com) for open-source simulation help.
...
This project was developed as academic coursework. If you are building on or referencing this design:

1. Fork the repository and create a feature branch.
2. Keep changes focused — one feature or fix per pull request.
3. Match the existing SystemVerilog coding style (module-per-file, consistent naming).
4. If adding new instructions or pipeline stages, update `tb.sv` and the relevant `.dat` test files.
5. Open a pull request with a clear description of what changed and why.

Please respect academic integrity policies at your institution if you are a student using this project as a reference.# 5-Stage Pipelined RV32I CPU
...
Please respect academic integrity policies at your institution if you are a student using this project as a reference.
